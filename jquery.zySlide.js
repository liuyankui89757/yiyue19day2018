...
(function ($) {
    ...
    function Slide(ele, options) {
        ...
        this.states = [
            { '&zIndex': 1, width: 400, height: 300, top: 71, left: 134, $opacity: 0.5 },
            { '&zIndex': 2, width: 500, height: 320, top: 61, left: 0, $opacity: 0.6 },
            { '&zIndex': 3, width: 600, height: 350, top: 37, left: 110, $opacity: 0.7 },
            { '&zIndex': 4, width: 694, height: 397, top: 0, left: 262, $opacity: 1 },
            { '&zIndex': 3, width: 600, height: 350, top: 37, left: 480, $opacity: 0.7 },
            { '&zIndex': 2, width: 500, height: 320, top: 61, left: 600, $opacity: 0.6 },
            { '&zIndex': 1, width: 400, height: 300, top: 71, left: 500, $opacity: 0.5 },
